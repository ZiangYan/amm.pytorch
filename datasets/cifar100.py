...
def make_loaders(train_batch=100, test_batch=100, num_val=5000):
    ...
    normalize = transforms.Normalize((0.5071, 0.4867, 0.4408), (1., 1., 1.))
    for phase in ['train', 'trainval', 'val', 'test']:
        ...
        loader = torch.utils.data.DataLoader(
            datasets.CIFAR100('data/pytorch-official/cifar100', train=is_train, download=True, transform=transform),
